...
namespace _3NewsAND
{
    [Activity(Label = "اليوم السابع", Icon = "@drawable/youm", Theme = "@android:style/Theme.Holo.Light")]
    public class FeedYoum7 : ListActivity
    {
        ...
        protected async override void OnCreate(Bundle bundle)
        {
            ...
            {
                var xmlFeed = await client.GetStringAsync("http://www.youm7.com/rss/SectionRss?SectionID=65");
                var doc = XDocument.Parse(xmlFeed);

                //XNamespace dc = "http://www.youm7.com/rss/SectionRss?SectionID=65";
